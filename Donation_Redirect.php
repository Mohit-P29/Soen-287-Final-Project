...
$amount = $_SESSION["donationpage_donationamount"];
...
$mail->addAddress($_SESSION["donationpage_email"],  $_SESSION["donation_first_name"]. " " . $_SESSION["donation_last_name"]
);
//Name is optional
...
$mail->Body = "Thank you for your " .  $amount . "$" . " donation " . $firstName . " " . $lastName . "<br>" . "Best Regards," . "<br>" . "Covaid,INC.";
...
header("location: Donation_PageConfirmation.php");
