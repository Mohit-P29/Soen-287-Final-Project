...
$mail->setFrom('info.covaid@gmail.com', 'CovAidTeam');
//Set an alternative reply-to address
//$mail->addReplyTo('replyto@example.com', 'First Last');
//Set who the message is to be sent to email and name
$message1=(isset($msg))?$msg:"";
$email1=(isset($email))?$email:"";
$name1=(isset($name))?$name:"Customer";

$mail->addAddress($email1,"Customer");
//Name is optional
...
$mail->Subject = 'CovAid Company';
//Read an HTML message body from an external file, convert referenced images to embedded,
//convert HTML into a basic plain-text alternative body


$mail->Body = "Dear ".$name."<br>".$message1;
