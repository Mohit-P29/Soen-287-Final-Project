...
$mail->Subject = 'Reset Password: CovAid Account';
//Read an HTML message body from an external file, convert referenced images to embedded,
//convert HTML into a basic plain-text alternative body
$mail->Body = "Dear ".$first." ".$last.",<br><br>"."This is the credential:<br>Login Email: ".$email."<br>Password: ".$password."<br><br>Best Regards,<br>"."Administrator";
