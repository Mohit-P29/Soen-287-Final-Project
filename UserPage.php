			...
			<div id="addcard" style="display:none;">
				<form class="MyOtherForm" id="addwalletform" style="padding-top:25px;" method="post" action="">
					<table style="float:left;text-align:left;border-spacing:15px;">
						...
						<tr>
							<td colspan="2"><input id="cardnumber" style="padding-left:0px;" name="cardnumber" type="text" class="Inputfield2" placeholder="1234 5678 1234 5678" value="<?php echo (isset($card)?$card:''); ?>" required maxlength="19" /></td>
						</tr>
						<tr>
							<td>First Name:<br /><input type="text" style="padding-left:0px;" id="pay_first" name="pay_first" class="Inputfield" placeholder="eg. Kate" value="<?php echo (isset($payfirst)?$payfirst:''); ?>" required /></td>
							<td>Last Name:<br /><input type="text" style="padding-left:0px;" id="pay_last" name="pay_last" class="Inputfield" placeholder="eg. Sims" value="<?php echo (isset($paylast)?$paylast:''); ?>" required /></td>
						</tr>
						<tr>
							<td colspan="2">
								Address:<br /><input type="text" style="padding-left:0px;" id="pay_address" class="Inputfield2" name="pay_address" placeholder="1234 Rue Somewhere" value="<?php echo (isset($payaddress)?$payaddress:''); ?>" required />
						...
						<tr>
							<td colspan="2">
								<input type="text" id="pay_city" class="Inputfield2" style="padding-left:0px;" name="pay_city" placeholder="Montreal" value="<?php echo (isset($paycity)?$paycity:''); ?>" required />
						...
						<tr>
							...
							<td><label for="Province">Province<br /><select class="Select" name="pay_province" id="pay_province" required>
										...
										<option value="Newfoundlan and Labrador">Newfoundlan and Labrador</option>
						...
						<tr>
							<td>Zip/Postal Code::<br /><input type="text" id="pay_post" style="padding-left:0px;" name="pay_post" class="Inputfield" placeholder="A1BC2D" value="<?php echo (isset($paypost)?$paypost:''); ?>" required maxlength="6" /></td>
    ...
    ?>
		...
		<div class="div5" id="div5">
			...
			<div id="DivForAddress" style="border-top:thin solid black; font-size:1.2em;padding-top: 20px;">
				...
				<table id="AddressT1" style="display: none;border-bottom: thin solid lightgray;border-spacing:15px;float:left;">
					...
					<tr><td>
							<form action="" method="post" ><input type="submit" id="datadelete1" name="delete_address" style="border: 0 none; background-color: white; color:black;text-decoration:underline;margin-left:0px; font-size:1.1em;font-weight:bold;" value="Remove" /></form>
						</td>
